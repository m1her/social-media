export default function Loading() {
  return (
    <div className="wrap-main flex flex-col items-center h-screen !border-0 relative">
      <div className="w-full bg-white h-16 absolute top-0 left-0"></div>
      <div className="col mt-32 w-[75%] rounded-lg">
      ...
      <div className="col mt-2 w-[75%] rounded-lg">
        <div className="main-block flex justify-center items-center !border-0">
          <div className="col">
            <div className="main-block !border-0">
              <div className=" bg-gray-white animate-pulse rounded-t w-full h-[150px]"></div>             
            </div>
          </div>
        </div>
      </div>
